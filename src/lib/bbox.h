...
struct BBox
{
	...
	bool hit(const Ray &ray, Vec2 &times) const
	{
		...
		// DISCLAIMER: most of the code taken from https://www.scratchapixel.com/lessons/3d-basic-rendering/minimal-ray-tracer-rendering-simple-shapes/ray-box-intersection.html

		const Vec3 &o = ray.point;
		const Vec3 &d = ray.dir;

		Vec3 invdir{1 / d.x, 1 / d.y, 1 / d.z};
