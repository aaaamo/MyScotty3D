...
Test test_a1_task7_index("a1.task7.index", []()
						 {
							 ...
							 SamplePattern pattern(SamplePattern::CustomBit | 1234, "just some test sample pattern", std::vector<Vec3>{Vec3(0.1f, 0.1f, 0.1f), Vec3(0.2f, 0.2f, 0.1f), Vec3(0.3f, 0.3f, 0.1f), Vec3(0.4f, 0.4f, 0.1f), Vec3(0.5f, 0.5f, 0.1f), Vec3(0.6f, 0.6f, 0.1f), Vec3(0.7f, 0.7f, 0.3f)});
...
Test test_a1_task7_resolve("a1.task7.resolve", []()
						   {
							   ...
							   if (resolved.at(0, 0) != Spectrum(0.0f, 0.0f, 0.0f) || resolved.at(0, 1) != Spectrum(0.0f, 0.0f, 0.0f) || resolved.at(1, 1) != Spectrum(0.0f, 0.0f, 0.0f))
							   {
